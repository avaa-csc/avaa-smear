...
/**
 * Provides the local service interface for HyyCoord. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author tkantola
 * @see HyyCoordLocalServiceUtil
...
public interface HyyCoordLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link HyyCoordLocalServiceUtil} to access the hyy coord local service. Add custom service methods to {@link fi.csc.avaa.smear.db.service.impl.HyyCoordLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
