...
/**
 * This class is used by SOAP remote services, specifically {@link fi.csc.smear.db.service.http.HyyDMPSServiceSoap}.
 *
 * @author pj
 * @see fi.csc.smear.db.service.http.HyyDMPSServiceSoap
 * @generated
 */
public class HyyDMPSSoap implements Serializable {
    ...
    public static HyyDMPSSoap toSoapModel(HyyDMPS model) {
        HyyDMPSSoap soapModel = new HyyDMPSSoap();
    ...
    public static HyyDMPSSoap[] toSoapModels(HyyDMPS[] models) {
        HyyDMPSSoap[] soapModels = new HyyDMPSSoap[models.length];
    ...
    public static HyyDMPSSoap[][] toSoapModels(HyyDMPS[][] models) {
        HyyDMPSSoap[][] soapModels = null;

        if (models.length > 0) {
            soapModels = new HyyDMPSSoap[models.length][models[0].length];
        } else {
            soapModels = new HyyDMPSSoap[0][0];
        }
    ...
    public static HyyDMPSSoap[] toSoapModels(List<HyyDMPS> models) {
        List<HyyDMPSSoap> soapModels = new ArrayList<HyyDMPSSoap>(models.size());

        for (HyyDMPS model : models) {
            soapModels.add(toSoapModel(model));
        }

        return soapModels.toArray(new HyyDMPSSoap[soapModels.size()]);
    }
