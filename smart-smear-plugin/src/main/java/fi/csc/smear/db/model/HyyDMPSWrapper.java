...
/**
 * <p>
 * This class is a wrapper for {@link HyyDMPS}.
 * </p>
 *
 * @author pj
 * @see HyyDMPS
 * @generated
 */
public class HyyDMPSWrapper implements HyyDMPS, ModelWrapper<HyyDMPS> {
    private HyyDMPS _hyyDMPS;

    public HyyDMPSWrapper(HyyDMPS hyyDMPS) {
        _hyyDMPS = hyyDMPS;
    }
    ...
    */
    ...
    public void setPrimaryKey(java.util.Date primaryKey) {
        _hyyDMPS.setPrimaryKey(primaryKey);
    }
    ...
    */
    ...
    public void setTconc(float tconc) {
        _hyyDMPS.setTconc(tconc);
    }

    @Override
    public boolean isNew() {
        return _hyyDMPS.isNew();
    }
    ...
    public boolean isCachedModel() {
        return _hyyDMPS.isCachedModel();
    }

    @Override
    public void setCachedModel(boolean cachedModel) {
        _hyyDMPS.setCachedModel(cachedModel);
    }

    @Override
    public boolean isEscapedModel() {
        return _hyyDMPS.isEscapedModel();
    }

    @Override
    public java.io.Serializable getPrimaryKeyObj() {
        return _hyyDMPS.getPrimaryKeyObj();
    }

    @Override
    public void setPrimaryKeyObj(java.io.Serializable primaryKeyObj) {
        _hyyDMPS.setPrimaryKeyObj(primaryKeyObj);
    }

    @Override
    public com.liferay.portlet.expando.model.ExpandoBridge getExpandoBridge() {
        return _hyyDMPS.getExpandoBridge();
    }

    @Override
    public void setExpandoBridgeAttributes(
        com.liferay.portal.model.BaseModel<?> baseModel) {
        _hyyDMPS.setExpandoBridgeAttributes(baseModel);
    }

    @Override
    public void setExpandoBridgeAttributes(
        com.liferay.portlet.expando.model.ExpandoBridge expandoBridge) {
        _hyyDMPS.setExpandoBridgeAttributes(expandoBridge);
    }

    @Override
    public void setExpandoBridgeAttributes(
        com.liferay.portal.service.ServiceContext serviceContext) {
        _hyyDMPS.setExpandoBridgeAttributes(serviceContext);
    }

    @Override
    public java.lang.Object clone() {
        return new HyyDMPSWrapper((HyyDMPS) _hyyDMPS.clone());
    }

    @Override
    public int compareTo(HyyDMPS hyyDMPS) {
        return _hyyDMPS.compareTo(hyyDMPS);
    }

    @Override
    public int hashCode() {
        return _hyyDMPS.hashCode();
    }

    @Override
    public com.liferay.portal.model.CacheModel<HyyDMPS> toCacheModel() {
        return _hyyDMPS.toCacheModel();
    }

    @Override
    public HyyDMPS toEscapedModel() {
        return new HyyDMPSWrapper(_hyyDMPS.toEscapedModel());
    }

    @Override
    public HyyDMPS toUnescapedModel() {
        return new HyyDMPSWrapper(_hyyDMPS.toUnescapedModel());
    }

    @Override
    public java.lang.String toString() {
        return _hyyDMPS.toString();
    }

    @Override
    public java.lang.String toXmlString() {
        return _hyyDMPS.toXmlString();
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof HyyDMPSWrapper)) {
            return false;
        }

        HyyDMPSWrapper hyyDMPSWrapper = (HyyDMPSWrapper) obj;

        if (Validator.equals(_hyyDMPS, hyyDMPSWrapper._hyyDMPS)) {
            return true;
        }
     ...
     */
    public HyyDMPS getWrappedHyyDMPS() {
        return _hyyDMPS;
    }

    @Override
    public HyyDMPS getWrappedModel() {
        return _hyyDMPS;
    }

    @Override
    public void resetOriginalValues() {
        _hyyDMPS.resetOriginalValues();
    }
}
