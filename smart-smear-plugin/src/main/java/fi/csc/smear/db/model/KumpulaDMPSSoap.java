...
/**
 * This class is used by SOAP remote services, specifically {@link fi.csc.smear.db.service.http.KumpulaDMPSServiceSoap}.
 *
 * @author pj
 * @see fi.csc.smear.db.service.http.KumpulaDMPSServiceSoap
 * @generated
 */
public class KumpulaDMPSSoap implements Serializable {
    ...
    public KumpulaDMPSSoap() {
    }

    public static KumpulaDMPSSoap toSoapModel(KumpulaDMPS model) {
        KumpulaDMPSSoap soapModel = new KumpulaDMPSSoap();
    ...
    public static KumpulaDMPSSoap[] toSoapModels(KumpulaDMPS[] models) {
        KumpulaDMPSSoap[] soapModels = new KumpulaDMPSSoap[models.length];
    ...
    public static KumpulaDMPSSoap[][] toSoapModels(KumpulaDMPS[][] models) {
        KumpulaDMPSSoap[][] soapModels = null;

        if (models.length > 0) {
            soapModels = new KumpulaDMPSSoap[models.length][models[0].length];
        } else {
            soapModels = new KumpulaDMPSSoap[0][0];
        }
    ...
    public static KumpulaDMPSSoap[] toSoapModels(List<KumpulaDMPS> models) {
        List<KumpulaDMPSSoap> soapModels = new ArrayList<KumpulaDMPSSoap>(models.size());

        for (KumpulaDMPS model : models) {
            soapModels.add(toSoapModel(model));
        }

        return soapModels.toArray(new KumpulaDMPSSoap[soapModels.size()]);
    }
