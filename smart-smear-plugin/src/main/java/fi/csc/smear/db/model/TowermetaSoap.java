...
/**
 * This class is used by SOAP remote services, specifically {@link fi.csc.smear.db.service.http.TowermetaServiceSoap}.
 *
 * @author pj
 * @see fi.csc.smear.db.service.http.TowermetaServiceSoap
 * @generated
 */
public class TowermetaSoap implements Serializable {
    ...
    public TowermetaSoap() {
    }

    public static TowermetaSoap toSoapModel(Towermeta model) {
        TowermetaSoap soapModel = new TowermetaSoap();
    ...
    public static TowermetaSoap[] toSoapModels(Towermeta[] models) {
        TowermetaSoap[] soapModels = new TowermetaSoap[models.length];
    ...
    public static TowermetaSoap[][] toSoapModels(Towermeta[][] models) {
        TowermetaSoap[][] soapModels = null;

        if (models.length > 0) {
            soapModels = new TowermetaSoap[models.length][models[0].length];
        } else {
            soapModels = new TowermetaSoap[0][0];
        }
    ...
    public static TowermetaSoap[] toSoapModels(List<Towermeta> models) {
        List<TowermetaSoap> soapModels = new ArrayList<TowermetaSoap>(models.size());

        for (Towermeta model : models) {
            soapModels.add(toSoapModel(model));
        }

        return soapModels.toArray(new TowermetaSoap[soapModels.size()]);
    }
