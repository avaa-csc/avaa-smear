...
/**
 * The base model interface for the VarDMPS service. Represents a row in the &quot;VAR_DMPS&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link fi.csc.smear.db.model.impl.VarDMPSModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link fi.csc.smear.db.model.impl.VarDMPSImpl}.
 * </p>
 *
 * @author pj
 * @see VarDMPS
 * @see fi.csc.smear.db.model.impl.VarDMPSImpl
 * @see fi.csc.smear.db.model.impl.VarDMPSModelImpl
 * @generated
 */
public interface VarDMPSModel extends BaseModel<VarDMPS> {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. All methods that expect a var d m p s model instance should use the {@link VarDMPS} interface instead.
     */
