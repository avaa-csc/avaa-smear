...
import fi.csc.smear.db.model.Sii1eddyModel;
import fi.csc.smear.db.model.Sii1eddySoap;
...
/**
 * The base model implementation for the Sii1eddy service. Represents a row in the &quot;SII1_EDDY&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link fi.csc.smear.db.model.Sii1eddyModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link Sii1eddyImpl}.
 * </p>
 *
 * @author pj
 * @see Sii1eddyImpl
 * @see fi.csc.smear.db.model.Sii1eddy
 * @see fi.csc.smear.db.model.Sii1eddyModel
 * @generated
 */
@JSON(strict = true)
public class Sii1eddyModelImpl extends BaseModelImpl<Sii1eddy>
    implements Sii1eddyModel {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. All methods that expect a sii1eddy model instance should use the {@link fi.csc.smear.db.model.Sii1eddy} interface instead.
     */
    public static final String TABLE_NAME = "SII1_EDDY";
    public static final Object[][] TABLE_COLUMNS = {
            ...
            { "F_c_LI70", Types.FLOAT },
            { "F_c_LI70_EMEP", Types.INTEGER },
            { "F_H2O_LI70", Types.FLOAT },
            { "F_H2O_LI70_EMEP", Types.INTEGER },
            { "F_CH4_LGR", Types.FLOAT },
            { "F_CH4_LGR_EMEP", Types.INTEGER },
            { "F_CH4_TGA", Types.FLOAT },
            { "F_CH4_TGA_EMEP", Types.INTEGER },
            { "F_H2O_PIC", Types.FLOAT },
            { "F_H2O_PIC_EMEP", Types.INTEGER },
            { "F_CH4_PIC", Types.FLOAT },
            { "F_CH4_PIC_EMEP", Types.INTEGER },
            { "LE_LI70", Types.FLOAT },
            { "LE_LI70_EMEP", Types.INTEGER },
            { "LE_PIC", Types.FLOAT },
            { "LE_PIC_EMEP", Types.INTEGER },
            { "av_u", Types.FLOAT },
            ...
            { "av_H2O_LI70", Types.FLOAT },
            { "av_H2O_LI70_EMEP", Types.INTEGER },
            { "av_CH4_LGR", Types.FLOAT },
            { "av_CH4_LGR_EMEP", Types.INTEGER },
            { "av_CH4_TGA", Types.FLOAT },
            { "av_CH4_TGA_EMEP", Types.INTEGER },
            { "av_H2O_PIC", Types.FLOAT },
            { "av_H2O_PIC_EMEP", Types.INTEGER },
            { "av_CH4_PIC", Types.FLOAT },
            { "av_CH4_PIC_EMEP", Types.INTEGER },
            { "std_u", Types.FLOAT },
            ...
            { "std_c_LI70", Types.FLOAT },
            { "std_c_LI70_EMEP", Types.INTEGER },
            { "std_H2O_LI70", Types.FLOAT },
            { "std_H2O_LI70_EMEP", Types.INTEGER },
            { "std_CH4_LGR", Types.FLOAT },
            { "std_CH4_LGR_EMEP", Types.INTEGER },
            { "std_CH4_TGA", Types.FLOAT },
            { "std_CH4_TGA_EMEP", Types.INTEGER },
            { "std_H2O_PIC", Types.FLOAT },
            { "std_H2O_PIC_EMEP", Types.INTEGER },
            { "std_CH4_PIC", Types.FLOAT },
            { "std_CH4_PIC_EMEP", Types.INTEGER },
            { "c_lag_LI70", Types.FLOAT },
            { "c_lag_LI70_EMEP", Types.INTEGER },
            { "H2O_lag_LI70", Types.FLOAT },
            { "H2O_lag_LI70_EMEP", Types.INTEGER },
            { "CH4_lag_LGR", Types.FLOAT },
            { "CH4_lag_LGR_EMEP", Types.INTEGER },
            { "CH4_lag_TGA", Types.FLOAT },
            { "CH4_lag_TGA_EMEP", Types.INTEGER },
            { "H2O_lag_PIC", Types.FLOAT },
            { "H2O_lag_PIC_EMEP", Types.INTEGER },
            { "CH4_lag_PIC", Types.FLOAT },
            { "CH4_lag_PIC_EMEP", Types.INTEGER },
            { "Qc_H", Types.INTEGER },
            { "Qc_H_EMEP", Types.INTEGER },
            { "Qc_CO2_LI70", Types.INTEGER },
            { "Qc_CO2_LI70_EMEP", Types.INTEGER },
            { "Qc_CH4_LGR", Types.INTEGER },
            { "Qc_CH4_LGR_EMEP", Types.INTEGER },
            { "Qc_CH4_TGA", Types.INTEGER },
            { "Qc_CH4_TGA_EMEP", Types.INTEGER },
            { "Qc_CH4_PIC", Types.INTEGER },
            { "Qc_CH4_PIC_EMEP", Types.INTEGER },
            { "Qc_LE_LI70", Types.INTEGER },
            { "Qc_LE_LI70_EMEP", Types.INTEGER },
            { "Qc_LE_PIC", Types.INTEGER },
            { "Qc_LE_PIC_EMEP", Types.INTEGER },
            { "Qc_tau", Types.INTEGER },
            { "Qc_tau_EMEP", Types.INTEGER }
        };
    public static final String TABLE_SQL_CREATE = "create table SII1_EDDY (samptime DATE not null primary key,U DOUBLE,U_EMEP INTEGER,wind_dir DOUBLE,wind_dir_EMEP INTEGER,eta DOUBLE,eta_EMEP INTEGER,theta DOUBLE,theta_EMEP INTEGER,beta DOUBLE,beta_EMEP INTEGER,H DOUBLE,H_EMEP INTEGER,tau DOUBLE,tau_EMEP INTEGER,u_star DOUBLE,u_star_EMEP INTEGER,MO_length DOUBLE,MO_length_EMEP INTEGER,err_packet DOUBLE,err_packet_EMEP INTEGER,F_c_LI70 DOUBLE,F_c_LI70_EMEP INTEGER,F_H2O_LI70 DOUBLE,F_H2O_LI70_EMEP INTEGER,F_CH4_LGR DOUBLE,F_CH4_LGR_EMEP INTEGER,F_CH4_TGA DOUBLE,F_CH4_TGA_EMEP INTEGER,F_H2O_PIC DOUBLE,F_H2O_PIC_EMEP INTEGER,F_CH4_PIC DOUBLE,F_CH4_PIC_EMEP INTEGER,LE_LI70 DOUBLE,LE_LI70_EMEP INTEGER,LE_PIC DOUBLE,LE_PIC_EMEP INTEGER,av_u DOUBLE,av_u_EMEP INTEGER,av_v DOUBLE,av_v_EMEP INTEGER,av_w DOUBLE,av_w_EMEP INTEGER,T_s DOUBLE,T_s_EMEP INTEGER,av_c DOUBLE,av_c_EMEP INTEGER,av_H2O_LI70 DOUBLE,av_H2O_LI70_EMEP INTEGER,av_CH4_LGR DOUBLE,av_CH4_LGR_EMEP INTEGER,av_CH4_TGA DOUBLE,av_CH4_TGA_EMEP INTEGER,av_H2O_PIC DOUBLE,av_H2O_PIC_EMEP INTEGER,av_CH4_PIC DOUBLE,av_CH4_PIC_EMEP INTEGER,std_u DOUBLE,std_u_EMEP INTEGER,std_v DOUBLE,std_v_EMEP INTEGER,std_w DOUBLE,std_w_EMEP INTEGER,std_T_s DOUBLE,std_T_s_EMEP INTEGER,std_c_LI70 DOUBLE,std_c_LI70_EMEP INTEGER,std_H2O_LI70 DOUBLE,std_H2O_LI70_EMEP INTEGER,std_CH4_LGR DOUBLE,std_CH4_LGR_EMEP INTEGER,std_CH4_TGA DOUBLE,std_CH4_TGA_EMEP INTEGER,std_H2O_PIC DOUBLE,std_H2O_PIC_EMEP INTEGER,std_CH4_PIC DOUBLE,std_CH4_PIC_EMEP INTEGER,c_lag_LI70 DOUBLE,c_lag_LI70_EMEP INTEGER,H2O_lag_LI70 DOUBLE,H2O_lag_LI70_EMEP INTEGER,CH4_lag_LGR DOUBLE,CH4_lag_LGR_EMEP INTEGER,CH4_lag_TGA DOUBLE,CH4_lag_TGA_EMEP INTEGER,H2O_lag_PIC DOUBLE,H2O_lag_PIC_EMEP INTEGER,CH4_lag_PIC DOUBLE,CH4_lag_PIC_EMEP INTEGER,Qc_H INTEGER,Qc_H_EMEP INTEGER,Qc_CO2_LI70 INTEGER,Qc_CO2_LI70_EMEP INTEGER,Qc_CH4_LGR INTEGER,Qc_CH4_LGR_EMEP INTEGER,Qc_CH4_TGA INTEGER,Qc_CH4_TGA_EMEP INTEGER,Qc_CH4_PIC INTEGER,Qc_CH4_PIC_EMEP INTEGER,Qc_LE_LI70 INTEGER,Qc_LE_LI70_EMEP INTEGER,Qc_LE_PIC INTEGER,Qc_LE_PIC_EMEP INTEGER,Qc_tau INTEGER,Qc_tau_EMEP INTEGER)";
    public static final String TABLE_SQL_DROP = "drop table SII1_EDDY";
    public static final String ORDER_BY_JPQL = " ORDER BY sii1eddy.samptime ASC";
    public static final String ORDER_BY_SQL = " ORDER BY SII1_EDDY.samptime ASC";
    ...
    public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.entity.cache.enabled.fi.csc.smear.db.model.Sii1eddy"),
            true);
    public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.finder.cache.enabled.fi.csc.smear.db.model.Sii1eddy"),
            true);
    public static final boolean COLUMN_BITMASK_ENABLED = false;
    public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
                "lock.expiration.time.fi.csc.smear.db.model.Sii1eddy"));
    private static ClassLoader _classLoader = Sii1eddy.class.getClassLoader();
    ...
    private Sii1eddy _escapedModel;

    public Sii1eddyModelImpl() {
    }
     ...
     */
    public static Sii1eddy toModel(Sii1eddySoap soapModel) {
        if (soapModel == null) {
            return null;
        }

        Sii1eddy model = new Sii1eddyImpl();
        ...
        model.setF_c_LI70(soapModel.getF_c_LI70());
        model.setF_c_LI70_EMEP(soapModel.getF_c_LI70_EMEP());
        model.setF_H2O_LI70(soapModel.getF_H2O_LI70());
        model.setF_H2O_LI70_EMEP(soapModel.getF_H2O_LI70_EMEP());
        model.setF_CH4_LGR(soapModel.getF_CH4_LGR());
        model.setF_CH4_LGR_EMEP(soapModel.getF_CH4_LGR_EMEP());
        model.setF_CH4_TGA(soapModel.getF_CH4_TGA());
        model.setF_CH4_TGA_EMEP(soapModel.getF_CH4_TGA_EMEP());
        model.setF_H2O_PIC(soapModel.getF_H2O_PIC());
        model.setF_H2O_PIC_EMEP(soapModel.getF_H2O_PIC_EMEP());
        model.setF_CH4_PIC(soapModel.getF_CH4_PIC());
        model.setF_CH4_PIC_EMEP(soapModel.getF_CH4_PIC_EMEP());
        model.setLE_LI70(soapModel.getLE_LI70());
        model.setLE_LI70_EMEP(soapModel.getLE_LI70_EMEP());
        model.setLE_PIC(soapModel.getLE_PIC());
        model.setLE_PIC_EMEP(soapModel.getLE_PIC_EMEP());
        ...
        model.setAv_H2O_LI70(soapModel.getAv_H2O_LI70());
        model.setAv_H2O_LI70_EMEP(soapModel.getAv_H2O_LI70_EMEP());
        model.setAv_CH4_LGR(soapModel.getAv_CH4_LGR());
        model.setAv_CH4_LGR_EMEP(soapModel.getAv_CH4_LGR_EMEP());
        model.setAv_CH4_TGA(soapModel.getAv_CH4_TGA());
        model.setAv_CH4_TGA_EMEP(soapModel.getAv_CH4_TGA_EMEP());
        model.setAv_H2O_PIC(soapModel.getAv_H2O_PIC());
        model.setAv_H2O_PIC_EMEP(soapModel.getAv_H2O_PIC_EMEP());
        model.setAv_CH4_PIC(soapModel.getAv_CH4_PIC());
        model.setAv_CH4_PIC_EMEP(soapModel.getAv_CH4_PIC_EMEP());
        ...
        model.setStd_c_LI70(soapModel.getStd_c_LI70());
        model.setStd_c_LI70_EMEP(soapModel.getStd_c_LI70_EMEP());
        model.setStd_H2O_LI70(soapModel.getStd_H2O_LI70());
        model.setStd_H2O_LI70_EMEP(soapModel.getStd_H2O_LI70_EMEP());
        model.setStd_CH4_LGR(soapModel.getStd_CH4_LGR());
        model.setStd_CH4_LGR_EMEP(soapModel.getStd_CH4_LGR_EMEP());
        model.setStd_CH4_TGA(soapModel.getStd_CH4_TGA());
        model.setStd_CH4_TGA_EMEP(soapModel.getStd_CH4_TGA_EMEP());
        model.setStd_H2O_PIC(soapModel.getStd_H2O_PIC());
        model.setStd_H2O_PIC_EMEP(soapModel.getStd_H2O_PIC_EMEP());
        model.setStd_CH4_PIC(soapModel.getStd_CH4_PIC());
        model.setStd_CH4_PIC_EMEP(soapModel.getStd_CH4_PIC_EMEP());
        model.setC_lag_LI70(soapModel.getC_lag_LI70());
        model.setC_lag_LI70_EMEP(soapModel.getC_lag_LI70_EMEP());
        model.setH2O_lag_LI70(soapModel.getH2O_lag_LI70());
        model.setH2O_lag_LI70_EMEP(soapModel.getH2O_lag_LI70_EMEP());
        model.setCH4_lag_LGR(soapModel.getCH4_lag_LGR());
        model.setCH4_lag_LGR_EMEP(soapModel.getCH4_lag_LGR_EMEP());
        model.setCH4_lag_TGA(soapModel.getCH4_lag_TGA());
        model.setCH4_lag_TGA_EMEP(soapModel.getCH4_lag_TGA_EMEP());
        model.setH2O_lag_PIC(soapModel.getH2O_lag_PIC());
        model.setH2O_lag_PIC_EMEP(soapModel.getH2O_lag_PIC_EMEP());
        model.setCH4_lag_PIC(soapModel.getCH4_lag_PIC());
        model.setCH4_lag_PIC_EMEP(soapModel.getCH4_lag_PIC_EMEP());
        ...
        model.setQc_CH4_LGR(soapModel.getQc_CH4_LGR());
        model.setQc_CH4_LGR_EMEP(soapModel.getQc_CH4_LGR_EMEP());
        model.setQc_CH4_TGA(soapModel.getQc_CH4_TGA());
        model.setQc_CH4_TGA_EMEP(soapModel.getQc_CH4_TGA_EMEP());
        model.setQc_CH4_PIC(soapModel.getQc_CH4_PIC());
        model.setQc_CH4_PIC_EMEP(soapModel.getQc_CH4_PIC_EMEP());
        model.setQc_LE_LI70(soapModel.getQc_LE_LI70());
        model.setQc_LE_LI70_EMEP(soapModel.getQc_LE_LI70_EMEP());
        model.setQc_LE_PIC(soapModel.getQc_LE_PIC());
        model.setQc_LE_PIC_EMEP(soapModel.getQc_LE_PIC_EMEP());
     ...
     */
    public static List<Sii1eddy> toModels(Sii1eddySoap[] soapModels) {
        if (soapModels == null) {
            return null;
        }

        List<Sii1eddy> models = new ArrayList<Sii1eddy>(soapModels.length);

        for (Sii1eddySoap soapModel : soapModels) {
    ...
    public Sii1eddy toEscapedModel() {
        if (_escapedModel == null) {
            _escapedModel = (Sii1eddy) ProxyUtil.newProxyInstance(_classLoader,
    ...
    public Object clone() {
        ...
        sii1eddyImpl.setSamptime(getSamptime());
        sii1eddyImpl.setU(getU());
        sii1eddyImpl.setU_EMEP(getU_EMEP());
        sii1eddyImpl.setWind_dir(getWind_dir());
        sii1eddyImpl.setWind_dir_EMEP(getWind_dir_EMEP());
        sii1eddyImpl.setEta(getEta());
        sii1eddyImpl.setEta_EMEP(getEta_EMEP());
        sii1eddyImpl.setTheta(getTheta());
        sii1eddyImpl.setTheta_EMEP(getTheta_EMEP());
        sii1eddyImpl.setBeta(getBeta());
        sii1eddyImpl.setBeta_EMEP(getBeta_EMEP());
        sii1eddyImpl.setH(getH());
        sii1eddyImpl.setH_EMEP(getH_EMEP());
        sii1eddyImpl.setTau(getTau());
        sii1eddyImpl.setTau_EMEP(getTau_EMEP());
        sii1eddyImpl.setU_star(getU_star());
        sii1eddyImpl.setU_star_EMEP(getU_star_EMEP());
        sii1eddyImpl.setMO_length(getMO_length());
        sii1eddyImpl.setMO_length_EMEP(getMO_length_EMEP());
        sii1eddyImpl.setErr_packet(getErr_packet());
        sii1eddyImpl.setErr_packet_EMEP(getErr_packet_EMEP());
        sii1eddyImpl.setF_c_LI70(getF_c_LI70());
        sii1eddyImpl.setF_c_LI70_EMEP(getF_c_LI70_EMEP());
        sii1eddyImpl.setF_H2O_LI70(getF_H2O_LI70());
        sii1eddyImpl.setF_H2O_LI70_EMEP(getF_H2O_LI70_EMEP());
        sii1eddyImpl.setF_CH4_LGR(getF_CH4_LGR());
        sii1eddyImpl.setF_CH4_LGR_EMEP(getF_CH4_LGR_EMEP());
        sii1eddyImpl.setF_CH4_TGA(getF_CH4_TGA());
        sii1eddyImpl.setF_CH4_TGA_EMEP(getF_CH4_TGA_EMEP());
        sii1eddyImpl.setF_H2O_PIC(getF_H2O_PIC());
        sii1eddyImpl.setF_H2O_PIC_EMEP(getF_H2O_PIC_EMEP());
        sii1eddyImpl.setF_CH4_PIC(getF_CH4_PIC());
        sii1eddyImpl.setF_CH4_PIC_EMEP(getF_CH4_PIC_EMEP());
        sii1eddyImpl.setLE_LI70(getLE_LI70());
        sii1eddyImpl.setLE_LI70_EMEP(getLE_LI70_EMEP());
        sii1eddyImpl.setLE_PIC(getLE_PIC());
        sii1eddyImpl.setLE_PIC_EMEP(getLE_PIC_EMEP());
        sii1eddyImpl.setAv_u(getAv_u());
        sii1eddyImpl.setAv_u_EMEP(getAv_u_EMEP());
        sii1eddyImpl.setAv_v(getAv_v());
        sii1eddyImpl.setAv_v_EMEP(getAv_v_EMEP());
        sii1eddyImpl.setAv_w(getAv_w());
        sii1eddyImpl.setAv_w_EMEP(getAv_w_EMEP());
        sii1eddyImpl.setT_s(getT_s());
        sii1eddyImpl.setT_s_EMEP(getT_s_EMEP());
        sii1eddyImpl.setAv_c(getAv_c());
        sii1eddyImpl.setAv_c_EMEP(getAv_c_EMEP());
        sii1eddyImpl.setAv_H2O_LI70(getAv_H2O_LI70());
        sii1eddyImpl.setAv_H2O_LI70_EMEP(getAv_H2O_LI70_EMEP());
        sii1eddyImpl.setAv_CH4_LGR(getAv_CH4_LGR());
        sii1eddyImpl.setAv_CH4_LGR_EMEP(getAv_CH4_LGR_EMEP());
        sii1eddyImpl.setAv_CH4_TGA(getAv_CH4_TGA());
        sii1eddyImpl.setAv_CH4_TGA_EMEP(getAv_CH4_TGA_EMEP());
        sii1eddyImpl.setAv_H2O_PIC(getAv_H2O_PIC());
        sii1eddyImpl.setAv_H2O_PIC_EMEP(getAv_H2O_PIC_EMEP());
        sii1eddyImpl.setAv_CH4_PIC(getAv_CH4_PIC());
        sii1eddyImpl.setAv_CH4_PIC_EMEP(getAv_CH4_PIC_EMEP());
        sii1eddyImpl.setStd_u(getStd_u());
        sii1eddyImpl.setStd_u_EMEP(getStd_u_EMEP());
        sii1eddyImpl.setStd_v(getStd_v());
        sii1eddyImpl.setStd_v_EMEP(getStd_v_EMEP());
        sii1eddyImpl.setStd_w(getStd_w());
        sii1eddyImpl.setStd_w_EMEP(getStd_w_EMEP());
        sii1eddyImpl.setStd_T_s(getStd_T_s());
        sii1eddyImpl.setStd_T_s_EMEP(getStd_T_s_EMEP());
        sii1eddyImpl.setStd_c_LI70(getStd_c_LI70());
        sii1eddyImpl.setStd_c_LI70_EMEP(getStd_c_LI70_EMEP());
        sii1eddyImpl.setStd_H2O_LI70(getStd_H2O_LI70());
        sii1eddyImpl.setStd_H2O_LI70_EMEP(getStd_H2O_LI70_EMEP());
        sii1eddyImpl.setStd_CH4_LGR(getStd_CH4_LGR());
        sii1eddyImpl.setStd_CH4_LGR_EMEP(getStd_CH4_LGR_EMEP());
        sii1eddyImpl.setStd_CH4_TGA(getStd_CH4_TGA());
        sii1eddyImpl.setStd_CH4_TGA_EMEP(getStd_CH4_TGA_EMEP());
        sii1eddyImpl.setStd_H2O_PIC(getStd_H2O_PIC());
        sii1eddyImpl.setStd_H2O_PIC_EMEP(getStd_H2O_PIC_EMEP());
        sii1eddyImpl.setStd_CH4_PIC(getStd_CH4_PIC());
        sii1eddyImpl.setStd_CH4_PIC_EMEP(getStd_CH4_PIC_EMEP());
        sii1eddyImpl.setC_lag_LI70(getC_lag_LI70());
        sii1eddyImpl.setC_lag_LI70_EMEP(getC_lag_LI70_EMEP());
        sii1eddyImpl.setH2O_lag_LI70(getH2O_lag_LI70());
        sii1eddyImpl.setH2O_lag_LI70_EMEP(getH2O_lag_LI70_EMEP());
        sii1eddyImpl.setCH4_lag_LGR(getCH4_lag_LGR());
        sii1eddyImpl.setCH4_lag_LGR_EMEP(getCH4_lag_LGR_EMEP());
        sii1eddyImpl.setCH4_lag_TGA(getCH4_lag_TGA());
        sii1eddyImpl.setCH4_lag_TGA_EMEP(getCH4_lag_TGA_EMEP());
        sii1eddyImpl.setH2O_lag_PIC(getH2O_lag_PIC());
        sii1eddyImpl.setH2O_lag_PIC_EMEP(getH2O_lag_PIC_EMEP());
        sii1eddyImpl.setCH4_lag_PIC(getCH4_lag_PIC());
        sii1eddyImpl.setCH4_lag_PIC_EMEP(getCH4_lag_PIC_EMEP());
        sii1eddyImpl.setQc_H(getQc_H());
        sii1eddyImpl.setQc_H_EMEP(getQc_H_EMEP());
        sii1eddyImpl.setQc_CO2_LI70(getQc_CO2_LI70());
        sii1eddyImpl.setQc_CO2_LI70_EMEP(getQc_CO2_LI70_EMEP());
        sii1eddyImpl.setQc_CH4_LGR(getQc_CH4_LGR());
        sii1eddyImpl.setQc_CH4_LGR_EMEP(getQc_CH4_LGR_EMEP());
        sii1eddyImpl.setQc_CH4_TGA(getQc_CH4_TGA());
        sii1eddyImpl.setQc_CH4_TGA_EMEP(getQc_CH4_TGA_EMEP());
        sii1eddyImpl.setQc_CH4_PIC(getQc_CH4_PIC());
        sii1eddyImpl.setQc_CH4_PIC_EMEP(getQc_CH4_PIC_EMEP());
        sii1eddyImpl.setQc_LE_LI70(getQc_LE_LI70());
        sii1eddyImpl.setQc_LE_LI70_EMEP(getQc_LE_LI70_EMEP());
        sii1eddyImpl.setQc_LE_PIC(getQc_LE_PIC());
        sii1eddyImpl.setQc_LE_PIC_EMEP(getQc_LE_PIC_EMEP());
        sii1eddyImpl.setQc_tau(getQc_tau());
        sii1eddyImpl.setQc_tau_EMEP(getQc_tau_EMEP());
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof Sii1eddy)) {
            return false;
        }

        Sii1eddy sii1eddy = (Sii1eddy) obj;
    ...
    public CacheModel<Sii1eddy> toCacheModel() {
        Sii1eddyCacheModel sii1eddyCacheModel = new Sii1eddyCacheModel();

        Date samptime = getSamptime();

        if (samptime != null) {
            sii1eddyCacheModel.samptime = samptime.getTime();
        } else {
            sii1eddyCacheModel.samptime = Long.MIN_VALUE;
        }

        sii1eddyCacheModel.U = getU();

        sii1eddyCacheModel.U_EMEP = getU_EMEP();

        sii1eddyCacheModel.wind_dir = getWind_dir();

        sii1eddyCacheModel.wind_dir_EMEP = getWind_dir_EMEP();

        sii1eddyCacheModel.eta = getEta();

        sii1eddyCacheModel.eta_EMEP = getEta_EMEP();

        sii1eddyCacheModel.theta = getTheta();

        sii1eddyCacheModel.theta_EMEP = getTheta_EMEP();

        sii1eddyCacheModel.beta = getBeta();

        sii1eddyCacheModel.beta_EMEP = getBeta_EMEP();

        sii1eddyCacheModel.H = getH();

        sii1eddyCacheModel.H_EMEP = getH_EMEP();

        sii1eddyCacheModel.tau = getTau();

        sii1eddyCacheModel.tau_EMEP = getTau_EMEP();

        sii1eddyCacheModel.u_star = getU_star();

        sii1eddyCacheModel.u_star_EMEP = getU_star_EMEP();

        sii1eddyCacheModel.MO_length = getMO_length();

        sii1eddyCacheModel.MO_length_EMEP = getMO_length_EMEP();

        sii1eddyCacheModel.err_packet = getErr_packet();

        sii1eddyCacheModel.err_packet_EMEP = getErr_packet_EMEP();

        sii1eddyCacheModel.F_c_LI70 = getF_c_LI70();

        sii1eddyCacheModel.F_c_LI70_EMEP = getF_c_LI70_EMEP();

        sii1eddyCacheModel.F_H2O_LI70 = getF_H2O_LI70();

        sii1eddyCacheModel.F_H2O_LI70_EMEP = getF_H2O_LI70_EMEP();

        sii1eddyCacheModel.F_CH4_LGR = getF_CH4_LGR();

        sii1eddyCacheModel.F_CH4_LGR_EMEP = getF_CH4_LGR_EMEP();

        sii1eddyCacheModel.F_CH4_TGA = getF_CH4_TGA();

        sii1eddyCacheModel.F_CH4_TGA_EMEP = getF_CH4_TGA_EMEP();

        sii1eddyCacheModel.F_H2O_PIC = getF_H2O_PIC();

        sii1eddyCacheModel.F_H2O_PIC_EMEP = getF_H2O_PIC_EMEP();

        sii1eddyCacheModel.F_CH4_PIC = getF_CH4_PIC();

        sii1eddyCacheModel.F_CH4_PIC_EMEP = getF_CH4_PIC_EMEP();

        sii1eddyCacheModel.LE_LI70 = getLE_LI70();

        sii1eddyCacheModel.LE_LI70_EMEP = getLE_LI70_EMEP();

        sii1eddyCacheModel.LE_PIC = getLE_PIC();

        sii1eddyCacheModel.LE_PIC_EMEP = getLE_PIC_EMEP();

        sii1eddyCacheModel.av_u = getAv_u();

        sii1eddyCacheModel.av_u_EMEP = getAv_u_EMEP();

        sii1eddyCacheModel.av_v = getAv_v();

        sii1eddyCacheModel.av_v_EMEP = getAv_v_EMEP();

        sii1eddyCacheModel.av_w = getAv_w();

        sii1eddyCacheModel.av_w_EMEP = getAv_w_EMEP();

        sii1eddyCacheModel.T_s = getT_s();

        sii1eddyCacheModel.T_s_EMEP = getT_s_EMEP();

        sii1eddyCacheModel.av_c = getAv_c();

        sii1eddyCacheModel.av_c_EMEP = getAv_c_EMEP();

        sii1eddyCacheModel.av_H2O_LI70 = getAv_H2O_LI70();

        sii1eddyCacheModel.av_H2O_LI70_EMEP = getAv_H2O_LI70_EMEP();

        sii1eddyCacheModel.av_CH4_LGR = getAv_CH4_LGR();

        sii1eddyCacheModel.av_CH4_LGR_EMEP = getAv_CH4_LGR_EMEP();

        sii1eddyCacheModel.av_CH4_TGA = getAv_CH4_TGA();

        sii1eddyCacheModel.av_CH4_TGA_EMEP = getAv_CH4_TGA_EMEP();

        sii1eddyCacheModel.av_H2O_PIC = getAv_H2O_PIC();

        sii1eddyCacheModel.av_H2O_PIC_EMEP = getAv_H2O_PIC_EMEP();

        sii1eddyCacheModel.av_CH4_PIC = getAv_CH4_PIC();

        sii1eddyCacheModel.av_CH4_PIC_EMEP = getAv_CH4_PIC_EMEP();

        sii1eddyCacheModel.std_u = getStd_u();

        sii1eddyCacheModel.std_u_EMEP = getStd_u_EMEP();

        sii1eddyCacheModel.std_v = getStd_v();

        sii1eddyCacheModel.std_v_EMEP = getStd_v_EMEP();

        sii1eddyCacheModel.std_w = getStd_w();

        sii1eddyCacheModel.std_w_EMEP = getStd_w_EMEP();

        sii1eddyCacheModel.std_T_s = getStd_T_s();

        sii1eddyCacheModel.std_T_s_EMEP = getStd_T_s_EMEP();

        sii1eddyCacheModel.std_c_LI70 = getStd_c_LI70();

        sii1eddyCacheModel.std_c_LI70_EMEP = getStd_c_LI70_EMEP();

        sii1eddyCacheModel.std_H2O_LI70 = getStd_H2O_LI70();

        sii1eddyCacheModel.std_H2O_LI70_EMEP = getStd_H2O_LI70_EMEP();

        sii1eddyCacheModel.std_CH4_LGR = getStd_CH4_LGR();

        sii1eddyCacheModel.std_CH4_LGR_EMEP = getStd_CH4_LGR_EMEP();

        sii1eddyCacheModel.std_CH4_TGA = getStd_CH4_TGA();

        sii1eddyCacheModel.std_CH4_TGA_EMEP = getStd_CH4_TGA_EMEP();

        sii1eddyCacheModel.std_H2O_PIC = getStd_H2O_PIC();

        sii1eddyCacheModel.std_H2O_PIC_EMEP = getStd_H2O_PIC_EMEP();

        sii1eddyCacheModel.std_CH4_PIC = getStd_CH4_PIC();

        sii1eddyCacheModel.std_CH4_PIC_EMEP = getStd_CH4_PIC_EMEP();

        sii1eddyCacheModel.c_lag_LI70 = getC_lag_LI70();

        sii1eddyCacheModel.c_lag_LI70_EMEP = getC_lag_LI70_EMEP();

        sii1eddyCacheModel.H2O_lag_LI70 = getH2O_lag_LI70();

        sii1eddyCacheModel.H2O_lag_LI70_EMEP = getH2O_lag_LI70_EMEP();

        sii1eddyCacheModel.CH4_lag_LGR = getCH4_lag_LGR();

        sii1eddyCacheModel.CH4_lag_LGR_EMEP = getCH4_lag_LGR_EMEP();

        sii1eddyCacheModel.CH4_lag_TGA = getCH4_lag_TGA();

        sii1eddyCacheModel.CH4_lag_TGA_EMEP = getCH4_lag_TGA_EMEP();

        sii1eddyCacheModel.H2O_lag_PIC = getH2O_lag_PIC();

        sii1eddyCacheModel.H2O_lag_PIC_EMEP = getH2O_lag_PIC_EMEP();

        sii1eddyCacheModel.CH4_lag_PIC = getCH4_lag_PIC();

        sii1eddyCacheModel.CH4_lag_PIC_EMEP = getCH4_lag_PIC_EMEP();

        sii1eddyCacheModel.Qc_H = getQc_H();

        sii1eddyCacheModel.Qc_H_EMEP = getQc_H_EMEP();

        sii1eddyCacheModel.Qc_CO2_LI70 = getQc_CO2_LI70();

        sii1eddyCacheModel.Qc_CO2_LI70_EMEP = getQc_CO2_LI70_EMEP();

        sii1eddyCacheModel.Qc_CH4_LGR = getQc_CH4_LGR();

        sii1eddyCacheModel.Qc_CH4_LGR_EMEP = getQc_CH4_LGR_EMEP();

        sii1eddyCacheModel.Qc_CH4_TGA = getQc_CH4_TGA();

        sii1eddyCacheModel.Qc_CH4_TGA_EMEP = getQc_CH4_TGA_EMEP();

        sii1eddyCacheModel.Qc_CH4_PIC = getQc_CH4_PIC();

        sii1eddyCacheModel.Qc_CH4_PIC_EMEP = getQc_CH4_PIC_EMEP();

        sii1eddyCacheModel.Qc_LE_LI70 = getQc_LE_LI70();

        sii1eddyCacheModel.Qc_LE_LI70_EMEP = getQc_LE_LI70_EMEP();

        sii1eddyCacheModel.Qc_LE_PIC = getQc_LE_PIC();

        sii1eddyCacheModel.Qc_LE_PIC_EMEP = getQc_LE_PIC_EMEP();

        sii1eddyCacheModel.Qc_tau = getQc_tau();

        sii1eddyCacheModel.Qc_tau_EMEP = getQc_tau_EMEP();

        return sii1eddyCacheModel;
    }
