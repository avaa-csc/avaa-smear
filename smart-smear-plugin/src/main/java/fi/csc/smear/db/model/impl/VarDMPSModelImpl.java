...
import fi.csc.smear.db.model.VarDMPSModel;
import fi.csc.smear.db.model.VarDMPSSoap;
...
/**
 * The base model implementation for the VarDMPS service. Represents a row in the &quot;VAR_DMPS&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This implementation and its corresponding interface {@link fi.csc.smear.db.model.VarDMPSModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link VarDMPSImpl}.
 * </p>
 *
 * @author pj
 * @see VarDMPSImpl
 * @see fi.csc.smear.db.model.VarDMPS
 * @see fi.csc.smear.db.model.VarDMPSModel
 * @generated
 */
@JSON(strict = true)
public class VarDMPSModelImpl extends BaseModelImpl<VarDMPS>
    implements VarDMPSModel {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this class directly. All methods that expect a var d m p s model instance should use the {@link fi.csc.smear.db.model.VarDMPS} interface instead.
     */
    public static final String TABLE_NAME = "VAR_DMPS";
    ...
    public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.entity.cache.enabled.fi.csc.smear.db.model.VarDMPS"),
            true);
    public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
                "value.object.finder.cache.enabled.fi.csc.smear.db.model.VarDMPS"),
            true);
    public static final boolean COLUMN_BITMASK_ENABLED = false;
    public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
                "lock.expiration.time.fi.csc.smear.db.model.VarDMPS"));
    private static ClassLoader _classLoader = VarDMPS.class.getClassLoader();
    ...
    private VarDMPS _escapedModel;

    public VarDMPSModelImpl() {
    }
     ...
     */
    public static VarDMPS toModel(VarDMPSSoap soapModel) {
        if (soapModel == null) {
            return null;
        }

        VarDMPS model = new VarDMPSImpl();
     ...
     */
    public static List<VarDMPS> toModels(VarDMPSSoap[] soapModels) {
        if (soapModels == null) {
            return null;
        }

        List<VarDMPS> models = new ArrayList<VarDMPS>(soapModels.length);

        for (VarDMPSSoap soapModel : soapModels) {
    ...
    public VarDMPS toEscapedModel() {
        if (_escapedModel == null) {
            _escapedModel = (VarDMPS) ProxyUtil.newProxyInstance(_classLoader,
    ...
    public Object clone() {
        ...
        varDMPSImpl.setSamptime(getSamptime());
        varDMPSImpl.setT1(getT1());
        varDMPSImpl.setT2(getT2());
        varDMPSImpl.setP1(getP1());
        varDMPSImpl.setP2(getP2());
        varDMPSImpl.setRh1(getRh1());
        varDMPSImpl.setRh2(getRh2());
        varDMPSImpl.setD100e1(getD100e1());
        varDMPSImpl.setD112e1(getD112e1());
        varDMPSImpl.setD126e1(getD126e1());
        varDMPSImpl.setD141e1(getD141e1());
        varDMPSImpl.setD158e1(getD158e1());
        varDMPSImpl.setD178e1(getD178e1());
        varDMPSImpl.setD200e1(getD200e1());
        varDMPSImpl.setD224e1(getD224e1());
        varDMPSImpl.setD251e1(getD251e1());
        varDMPSImpl.setD282e1(getD282e1());
        varDMPSImpl.setD316e1(getD316e1());
        varDMPSImpl.setD355e1(getD355e1());
        varDMPSImpl.setD398e1(getD398e1());
        varDMPSImpl.setD447e1(getD447e1());
        varDMPSImpl.setD501e1(getD501e1());
        varDMPSImpl.setD562e1(getD562e1());
        varDMPSImpl.setD631e1(getD631e1());
        varDMPSImpl.setD708e1(getD708e1());
        varDMPSImpl.setD794e1(getD794e1());
        varDMPSImpl.setD891e1(getD891e1());
        varDMPSImpl.setD100e2(getD100e2());
        varDMPSImpl.setD112e2(getD112e2());
        varDMPSImpl.setD126e2(getD126e2());
        varDMPSImpl.setD141e2(getD141e2());
        varDMPSImpl.setD158e2(getD158e2());
        varDMPSImpl.setD178e2(getD178e2());
        varDMPSImpl.setD200e2(getD200e2());
        varDMPSImpl.setD224e2(getD224e2());
        varDMPSImpl.setD251e2(getD251e2());
        varDMPSImpl.setD282e2(getD282e2());
        varDMPSImpl.setD316e2(getD316e2());
        varDMPSImpl.setD355e2(getD355e2());
        varDMPSImpl.setD398e2(getD398e2());
        varDMPSImpl.setD447e2(getD447e2());
        varDMPSImpl.setD501e2(getD501e2());
        varDMPSImpl.setD562e2(getD562e2());
        varDMPSImpl.setD631e2(getD631e2());
        varDMPSImpl.setD708e2(getD708e2());
        varDMPSImpl.setD794e2(getD794e2());
        varDMPSImpl.setD891e2(getD891e2());
        varDMPSImpl.setD100e3(getD100e3());
        varDMPSImpl.setD112e3(getD112e3());
        varDMPSImpl.setD126e3(getD126e3());
        varDMPSImpl.setD141e3(getD141e3());
        varDMPSImpl.setD158e3(getD158e3());
        varDMPSImpl.setD178e3(getD178e3());
        varDMPSImpl.setD200e3(getD200e3());
        varDMPSImpl.setD224e3(getD224e3());
        varDMPSImpl.setD251e3(getD251e3());
        varDMPSImpl.setD282e3(getD282e3());
        varDMPSImpl.setD316e3(getD316e3());
        varDMPSImpl.setD355e3(getD355e3());
        varDMPSImpl.setD398e3(getD398e3());
        varDMPSImpl.setD447e3(getD447e3());
        varDMPSImpl.setD501e3(getD501e3());
        varDMPSImpl.setD562e3(getD562e3());
        varDMPSImpl.setD631e3(getD631e3());
        varDMPSImpl.setD708e3(getD708e3());
        varDMPSImpl.setD794e3(getD794e3());
        varDMPSImpl.setD891e3(getD891e3());
        varDMPSImpl.setD100e4(getD100e4());
        varDMPSImpl.setTconc(getTconc());
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof VarDMPS)) {
            return false;
        }

        VarDMPS varDMPS = (VarDMPS) obj;
    ...
    public CacheModel<VarDMPS> toCacheModel() {
        VarDMPSCacheModel varDMPSCacheModel = new VarDMPSCacheModel();

        Date samptime = getSamptime();

        if (samptime != null) {
            varDMPSCacheModel.samptime = samptime.getTime();
        } else {
            varDMPSCacheModel.samptime = Long.MIN_VALUE;
        }

        varDMPSCacheModel.t1 = getT1();

        varDMPSCacheModel.t2 = getT2();

        varDMPSCacheModel.p1 = getP1();

        varDMPSCacheModel.p2 = getP2();

        varDMPSCacheModel.rh1 = getRh1();

        varDMPSCacheModel.rh2 = getRh2();

        varDMPSCacheModel.d100e1 = getD100e1();

        varDMPSCacheModel.d112e1 = getD112e1();

        varDMPSCacheModel.d126e1 = getD126e1();

        varDMPSCacheModel.d141e1 = getD141e1();

        varDMPSCacheModel.d158e1 = getD158e1();

        varDMPSCacheModel.d178e1 = getD178e1();

        varDMPSCacheModel.d200e1 = getD200e1();

        varDMPSCacheModel.d224e1 = getD224e1();

        varDMPSCacheModel.d251e1 = getD251e1();

        varDMPSCacheModel.d282e1 = getD282e1();

        varDMPSCacheModel.d316e1 = getD316e1();

        varDMPSCacheModel.d355e1 = getD355e1();

        varDMPSCacheModel.d398e1 = getD398e1();

        varDMPSCacheModel.d447e1 = getD447e1();

        varDMPSCacheModel.d501e1 = getD501e1();

        varDMPSCacheModel.d562e1 = getD562e1();

        varDMPSCacheModel.d631e1 = getD631e1();

        varDMPSCacheModel.d708e1 = getD708e1();

        varDMPSCacheModel.d794e1 = getD794e1();

        varDMPSCacheModel.d891e1 = getD891e1();

        varDMPSCacheModel.d100e2 = getD100e2();

        varDMPSCacheModel.d112e2 = getD112e2();

        varDMPSCacheModel.d126e2 = getD126e2();

        varDMPSCacheModel.d141e2 = getD141e2();

        varDMPSCacheModel.d158e2 = getD158e2();

        varDMPSCacheModel.d178e2 = getD178e2();

        varDMPSCacheModel.d200e2 = getD200e2();

        varDMPSCacheModel.d224e2 = getD224e2();

        varDMPSCacheModel.d251e2 = getD251e2();

        varDMPSCacheModel.d282e2 = getD282e2();

        varDMPSCacheModel.d316e2 = getD316e2();

        varDMPSCacheModel.d355e2 = getD355e2();

        varDMPSCacheModel.d398e2 = getD398e2();

        varDMPSCacheModel.d447e2 = getD447e2();

        varDMPSCacheModel.d501e2 = getD501e2();

        varDMPSCacheModel.d562e2 = getD562e2();

        varDMPSCacheModel.d631e2 = getD631e2();

        varDMPSCacheModel.d708e2 = getD708e2();

        varDMPSCacheModel.d794e2 = getD794e2();

        varDMPSCacheModel.d891e2 = getD891e2();

        varDMPSCacheModel.d100e3 = getD100e3();

        varDMPSCacheModel.d112e3 = getD112e3();

        varDMPSCacheModel.d126e3 = getD126e3();

        varDMPSCacheModel.d141e3 = getD141e3();

        varDMPSCacheModel.d158e3 = getD158e3();

        varDMPSCacheModel.d178e3 = getD178e3();

        varDMPSCacheModel.d200e3 = getD200e3();

        varDMPSCacheModel.d224e3 = getD224e3();

        varDMPSCacheModel.d251e3 = getD251e3();

        varDMPSCacheModel.d282e3 = getD282e3();

        varDMPSCacheModel.d316e3 = getD316e3();

        varDMPSCacheModel.d355e3 = getD355e3();

        varDMPSCacheModel.d398e3 = getD398e3();

        varDMPSCacheModel.d447e3 = getD447e3();

        varDMPSCacheModel.d501e3 = getD501e3();

        varDMPSCacheModel.d562e3 = getD562e3();

        varDMPSCacheModel.d631e3 = getD631e3();

        varDMPSCacheModel.d708e3 = getD708e3();

        varDMPSCacheModel.d794e3 = getD794e3();

        varDMPSCacheModel.d891e3 = getD891e3();

        varDMPSCacheModel.d100e4 = getD100e4();

        varDMPSCacheModel.tconc = getTconc();

        return varDMPSCacheModel;
    }
