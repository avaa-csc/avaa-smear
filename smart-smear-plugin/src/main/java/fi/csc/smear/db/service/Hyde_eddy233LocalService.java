...
/**
 * Provides the local service interface for Hyde_eddy233. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author pj
 * @see Hyde_eddy233LocalServiceUtil
...
public interface Hyde_eddy233LocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link Hyde_eddy233LocalServiceUtil} to access the hyde_eddy233 local service. Add custom service methods to {@link fi.csc.smear.db.service.impl.Hyde_eddy233LocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
