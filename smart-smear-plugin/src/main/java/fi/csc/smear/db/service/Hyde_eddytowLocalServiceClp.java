 ...
 * @generated
 */
public class Hyde_eddytowLocalServiceClp implements Hyde_eddytowLocalService {
    ...
    public Hyde_eddytowLocalServiceClp(
    ...
    public fi.csc.smear.db.model.Hyde_eddytow addHyde_eddytow(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(hyde_eddytow) });
        } catch (Throwable t) {
        ...
        return (fi.csc.smear.db.model.Hyde_eddytow) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<fi.csc.smear.db.model.Hyde_eddytow> getHyde_eddytows(
        ...
        return (java.util.List<fi.csc.smear.db.model.Hyde_eddytow>) ClpSerializer.translateOutput(returnObj);
    }
