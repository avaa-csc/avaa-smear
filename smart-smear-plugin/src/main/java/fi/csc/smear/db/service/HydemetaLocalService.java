...
/**
 * Provides the local service interface for Hydemeta. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author pj
 * @see HydemetaLocalServiceUtil
...
public interface HydemetaLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link HydemetaLocalServiceUtil} to access the hydemeta local service. Add custom service methods to {@link fi.csc.smear.db.service.impl.HydemetaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
