 ...
 * @generated
 */
public class HydemetaLocalServiceClp implements HydemetaLocalService {
    ...
    public HydemetaLocalServiceClp(InvokableLocalService invokableLocalService) {
    ...
    public fi.csc.smear.db.model.Hydemeta addHydemeta(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(hydemeta) });
        } catch (Throwable t) {
        ...
        return (fi.csc.smear.db.model.Hydemeta) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<fi.csc.smear.db.model.Hydemeta> getHydemetas(
        ...
        return (java.util.List<fi.csc.smear.db.model.Hydemeta>) ClpSerializer.translateOutput(returnObj);
    }
