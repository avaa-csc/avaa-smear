 ...
 * @generated
 */
public class HyyAeroLocalServiceClp implements HyyAeroLocalService {
    ...
    public HyyAeroLocalServiceClp(InvokableLocalService invokableLocalService) {
    ...
    public fi.csc.smear.db.model.HyyAero addHyyAero(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(hyyAero) });
        } catch (Throwable t) {
        ...
        return (fi.csc.smear.db.model.HyyAero) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<fi.csc.smear.db.model.HyyAero> getHyyAeros(
        ...
        return (java.util.List<fi.csc.smear.db.model.HyyAero>) ClpSerializer.translateOutput(returnObj);
    }
