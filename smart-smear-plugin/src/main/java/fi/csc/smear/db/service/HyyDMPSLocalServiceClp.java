 ...
 * @generated
 */
public class HyyDMPSLocalServiceClp implements HyyDMPSLocalService {
    ...
    public HyyDMPSLocalServiceClp(InvokableLocalService invokableLocalService) {
    ...
    public fi.csc.smear.db.model.HyyDMPS addHyyDMPS(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(hyyDMPS) });
        } catch (Throwable t) {
        ...
        return (fi.csc.smear.db.model.HyyDMPS) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<fi.csc.smear.db.model.HyyDMPS> getHyyDMPSs(
        ...
        return (java.util.List<fi.csc.smear.db.model.HyyDMPS>) ClpSerializer.translateOutput(returnObj);
    }
