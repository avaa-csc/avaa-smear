...
/**
 * Provides the local service interface for Hyy_eddysub. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author pj
 * @see Hyy_eddysubLocalServiceUtil
...
public interface Hyy_eddysubLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link Hyy_eddysubLocalServiceUtil} to access the hyy_eddysub local service. Add custom service methods to {@link fi.csc.smear.db.service.impl.Hyy_eddysubLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
