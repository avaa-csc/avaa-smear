 ...
 * @generated
 */
public class Hyy_eddysubLocalServiceClp implements Hyy_eddysubLocalService {
    ...
    public Hyy_eddysubLocalServiceClp(
    ...
    public fi.csc.smear.db.model.Hyy_eddysub addHyy_eddysub(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(hyy_eddysub) });
        } catch (Throwable t) {
        ...
        return (fi.csc.smear.db.model.Hyy_eddysub) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<fi.csc.smear.db.model.Hyy_eddysub> getHyy_eddysubs(
        ...
        return (java.util.List<fi.csc.smear.db.model.Hyy_eddysub>) ClpSerializer.translateOutput(returnObj);
    }
