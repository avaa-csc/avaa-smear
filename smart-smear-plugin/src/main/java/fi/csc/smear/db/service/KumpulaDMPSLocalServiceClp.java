 ...
 * @generated
 */
public class KumpulaDMPSLocalServiceClp implements KumpulaDMPSLocalService {
    ...
    public KumpulaDMPSLocalServiceClp(
    ...
    public fi.csc.smear.db.model.KumpulaDMPS addKumpulaDMPS(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(kumpulaDMPS) });
        } catch (Throwable t) {
        ...
        return (fi.csc.smear.db.model.KumpulaDMPS) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<fi.csc.smear.db.model.KumpulaDMPS> getKumpulaDMPSs(
        ...
        return (java.util.List<fi.csc.smear.db.model.KumpulaDMPS>) ClpSerializer.translateOutput(returnObj);
    }
