 ...
 * @generated
 */
public class Kumpula_eddyLocalServiceClp implements Kumpula_eddyLocalService {
    ...
    public Kumpula_eddyLocalServiceClp(
    ...
    public fi.csc.smear.db.model.Kumpula_eddy addKumpula_eddy(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(kumpula_eddy) });
        } catch (Throwable t) {
        ...
        return (fi.csc.smear.db.model.Kumpula_eddy) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<fi.csc.smear.db.model.Kumpula_eddy> getKumpula_eddies(
        ...
        return (java.util.List<fi.csc.smear.db.model.Kumpula_eddy>) ClpSerializer.translateOutput(returnObj);
    }
