...
/**
 * Provides the local service interface for Kumpulameta. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author pj
 * @see KumpulametaLocalServiceUtil
...
public interface KumpulametaLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link KumpulametaLocalServiceUtil} to access the kumpulameta local service. Add custom service methods to {@link fi.csc.smear.db.service.impl.KumpulametaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
