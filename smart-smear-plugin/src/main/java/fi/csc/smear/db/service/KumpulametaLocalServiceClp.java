 ...
 * @generated
 */
public class KumpulametaLocalServiceClp implements KumpulametaLocalService {
    ...
    public KumpulametaLocalServiceClp(
    ...
    public fi.csc.smear.db.model.Kumpulameta addKumpulameta(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(kumpulameta) });
        } catch (Throwable t) {
        ...
        return (fi.csc.smear.db.model.Kumpulameta) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<fi.csc.smear.db.model.Kumpulameta> getKumpulametas(
        ...
        return (java.util.List<fi.csc.smear.db.model.Kumpulameta>) ClpSerializer.translateOutput(returnObj);
    }
