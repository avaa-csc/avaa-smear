 ...
 * @generated
 */
public class Sii1metaLocalServiceClp implements Sii1metaLocalService {
    ...
    public Sii1metaLocalServiceClp(InvokableLocalService invokableLocalService) {
    ...
    public fi.csc.smear.db.model.Sii1meta addSii1meta(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(sii1meta) });
        } catch (Throwable t) {
        ...
        return (fi.csc.smear.db.model.Sii1meta) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<fi.csc.smear.db.model.Sii1meta> getSii1metas(
        ...
        return (java.util.List<fi.csc.smear.db.model.Sii1meta>) ClpSerializer.translateOutput(returnObj);
    }
