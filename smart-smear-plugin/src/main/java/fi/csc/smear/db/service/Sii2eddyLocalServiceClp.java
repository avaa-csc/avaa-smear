 ...
 * @generated
 */
public class Sii2eddyLocalServiceClp implements Sii2eddyLocalService {
    ...
    public Sii2eddyLocalServiceClp(InvokableLocalService invokableLocalService) {
    ...
    public fi.csc.smear.db.model.Sii2eddy addSii2eddy(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(sii2eddy) });
        } catch (Throwable t) {
        ...
        return (fi.csc.smear.db.model.Sii2eddy) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<fi.csc.smear.db.model.Sii2eddy> getSii2eddies(
        ...
        return (java.util.List<fi.csc.smear.db.model.Sii2eddy>) ClpSerializer.translateOutput(returnObj);
    }
