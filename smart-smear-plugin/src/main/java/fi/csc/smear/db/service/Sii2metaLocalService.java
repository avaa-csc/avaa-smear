...
/**
 * Provides the local service interface for Sii2meta. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author pj
 * @see Sii2metaLocalServiceUtil
...
public interface Sii2metaLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link Sii2metaLocalServiceUtil} to access the sii2meta local service. Add custom service methods to {@link fi.csc.smear.db.service.impl.Sii2metaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
