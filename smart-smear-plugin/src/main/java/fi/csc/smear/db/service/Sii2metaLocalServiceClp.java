 ...
 * @generated
 */
public class Sii2metaLocalServiceClp implements Sii2metaLocalService {
    ...
    public Sii2metaLocalServiceClp(InvokableLocalService invokableLocalService) {
    ...
    public fi.csc.smear.db.model.Sii2meta addSii2meta(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(sii2meta) });
        } catch (Throwable t) {
        ...
        return (fi.csc.smear.db.model.Sii2meta) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<fi.csc.smear.db.model.Sii2meta> getSii2metas(
        ...
        return (java.util.List<fi.csc.smear.db.model.Sii2meta>) ClpSerializer.translateOutput(returnObj);
    }
