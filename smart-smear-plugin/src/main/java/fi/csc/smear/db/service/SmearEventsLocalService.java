...
/**
 * Provides the local service interface for SmearEvents. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author pj
 * @see SmearEventsLocalServiceUtil
...
public interface SmearEventsLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link SmearEventsLocalServiceUtil} to access the smear events local service. Add custom service methods to {@link fi.csc.smear.db.service.impl.SmearEventsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
