 ...
 * @generated
 */
public class SmearTableMetadataLocalServiceClp
    ...
    public SmearTableMetadataLocalServiceClp(
    ...
    public fi.csc.smear.db.model.SmearTableMetadata addSmearTableMetadata(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(smearTableMetadata)
                    });
        } catch (Throwable t) {
        ...
        return (fi.csc.smear.db.model.SmearTableMetadata) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public fi.csc.smear.db.model.SmearTableMetadata createSmearTableMetadata(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { tableID });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public fi.csc.smear.db.model.SmearTableMetadata deleteSmearTableMetadata(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { tableID });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public fi.csc.smear.db.model.SmearTableMetadata fetchSmearTableMetadata(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { tableID });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public fi.csc.smear.db.model.SmearTableMetadata getSmearTableMetadata(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { tableID });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<fi.csc.smear.db.model.SmearTableMetadata> getSmearTableMetadatas(
        ...
        return (java.util.List<fi.csc.smear.db.model.SmearTableMetadata>) ClpSerializer.translateOutput(returnObj);
    }
