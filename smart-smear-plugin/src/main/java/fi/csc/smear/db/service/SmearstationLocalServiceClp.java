 ...
 * @generated
 */
public class SmearstationLocalServiceClp implements SmearstationLocalService {
    ...
    public SmearstationLocalServiceClp(
    ...
    public fi.csc.smear.db.model.Smearstation addSmearstation(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(smearstation) });
        } catch (Throwable t) {
        ...
        return (fi.csc.smear.db.model.Smearstation) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public fi.csc.smear.db.model.Smearstation createSmearstation(long stationID) {
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    _methodParameterTypes1, new Object[] { stationID });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public fi.csc.smear.db.model.Smearstation deleteSmearstation(long stationID)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName2,
                    _methodParameterTypes2, new Object[] { stationID });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public fi.csc.smear.db.model.Smearstation fetchSmearstation(long stationID)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName10,
                    _methodParameterTypes10, new Object[] { stationID });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public fi.csc.smear.db.model.Smearstation getSmearstation(long stationID)
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName11,
                    _methodParameterTypes11, new Object[] { stationID });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<fi.csc.smear.db.model.Smearstation> getSmearstations(
        ...
        return (java.util.List<fi.csc.smear.db.model.Smearstation>) ClpSerializer.translateOutput(returnObj);
    }
