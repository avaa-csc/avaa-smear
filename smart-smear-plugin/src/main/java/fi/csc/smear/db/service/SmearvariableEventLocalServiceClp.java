 ...
 * @generated
 */
public class SmearvariableEventLocalServiceClp
    ...
    public SmearvariableEventLocalServiceClp(
    ...
    public fi.csc.smear.db.model.SmearvariableEvent addSmearvariableEvent(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(smearvariableEvent)
                    });
        } catch (Throwable t) {
        ...
        return (fi.csc.smear.db.model.SmearvariableEvent) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public fi.csc.smear.db.model.SmearvariableEvent createSmearvariableEvent(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName1,
                    ...
                    new Object[] {
                        ClpSerializer.translateInput(smearvariableEventPK)
                    });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
    ...
    public java.util.List<fi.csc.smear.db.model.SmearvariableEvent> getSmearvariableEvents(
        ...
        return (java.util.List<fi.csc.smear.db.model.SmearvariableEvent>) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<fi.csc.smear.db.model.SmearvariableEvent> findByVariable(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName19,
                    _methodParameterTypes19, new Object[] { varId });
        } catch (Throwable t) {
            t = ClpSerializer.translateThrowable(t);
