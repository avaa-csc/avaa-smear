...
/**
 * Provides the local service interface for SmearvariableTags. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author pj
 * @see SmearvariableTagsLocalServiceUtil
...
public interface SmearvariableTagsLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link SmearvariableTagsLocalServiceUtil} to access the smearvariable tags local service. Add custom service methods to {@link fi.csc.smear.db.service.impl.SmearvariableTagsLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
