...
/**
 * Provides the local service interface for Varrio_tree. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author pj
 * @see Varrio_treeLocalServiceUtil
...
public interface Varrio_treeLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link Varrio_treeLocalServiceUtil} to access the varrio_tree local service. Add custom service methods to {@link fi.csc.smear.db.service.impl.Varrio_treeLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
