 ...
 * @generated
 */
public class Varrio_treeLocalServiceClp implements Varrio_treeLocalService {
    ...
    public Varrio_treeLocalServiceClp(
    ...
    public fi.csc.smear.db.model.Varrio_tree addVarrio_tree(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(varrio_tree) });
        } catch (Throwable t) {
        ...
        return (fi.csc.smear.db.model.Varrio_tree) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<fi.csc.smear.db.model.Varrio_tree> getVarrio_trees(
        ...
        return (java.util.List<fi.csc.smear.db.model.Varrio_tree>) ClpSerializer.translateOutput(returnObj);
    }
