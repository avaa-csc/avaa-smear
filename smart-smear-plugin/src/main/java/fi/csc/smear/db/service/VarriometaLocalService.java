...
/**
 * Provides the local service interface for Varriometa. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author pj
 * @see VarriometaLocalServiceUtil
...
public interface VarriometaLocalService extends BaseLocalService,
    InvokableLocalService, PersistedModelLocalService {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link VarriometaLocalServiceUtil} to access the varriometa local service. Add custom service methods to {@link fi.csc.smear.db.service.impl.VarriometaLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
     */
