 ...
 * @generated
 */
public class kvjMetaLocalServiceClp implements kvjMetaLocalService {
    ...
    public kvjMetaLocalServiceClp(InvokableLocalService invokableLocalService) {
    ...
    public fi.csc.smear.db.model.kvjMeta addkvjMeta(
        ...
        try {
            returnObj = _invokableLocalService.invokeMethod(_methodName0,
                    ...
                    new Object[] { ClpSerializer.translateInput(kvjMeta) });
        } catch (Throwable t) {
        ...
        return (fi.csc.smear.db.model.kvjMeta) ClpSerializer.translateOutput(returnObj);
    }
    ...
    public java.util.List<fi.csc.smear.db.model.kvjMeta> getkvjMetas(
        ...
        return (java.util.List<fi.csc.smear.db.model.kvjMeta>) ClpSerializer.translateOutput(returnObj);
    }
