...
/**
 * The persistence interface for the hyde_eddy233 service.
 *
 * <p>
 ...
 * @generated
 */
public interface Hyde_eddy233Persistence extends BasePersistence<Hyde_eddy233> {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link Hyde_eddy233Util} to access the hyde_eddy233 persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
     */
    ...
    */
    public void cacheResult(fi.csc.smear.db.model.Hyde_eddy233 hyde_eddy233);
    ...
    */
    public fi.csc.smear.db.model.Hyde_eddy233 create(java.util.Date samptime);
    ...
    */
    public fi.csc.smear.db.model.Hyde_eddy233 remove(java.util.Date samptime)
        throws com.liferay.portal.kernel.exception.SystemException,
            fi.csc.smear.db.NoSuchHyde_eddy233Exception;

    public fi.csc.smear.db.model.Hyde_eddy233 updateImpl(
    ...
    * @throws SystemException if a system exception occurred
    */
    public fi.csc.smear.db.model.Hyde_eddy233 findByPrimaryKey(
    ...
    * @throws SystemException if a system exception occurred
    */
    public fi.csc.smear.db.model.Hyde_eddy233 fetchByPrimaryKey(
        java.util.Date samptime)
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    * @throws SystemException if a system exception occurred
    */
    public java.util.List<fi.csc.smear.db.model.Hyde_eddy233> findAll()
        throws com.liferay.portal.kernel.exception.SystemException;
