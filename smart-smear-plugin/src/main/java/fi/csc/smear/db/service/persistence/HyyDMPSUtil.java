...
/**
 * The persistence utility for the hyy d m p s service. This utility wraps {@link HyyDMPSPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class HyyDMPSUtil {
    private static HyyDMPSPersistence _persistence;
     ...
     */
    public static void clearCache(HyyDMPS hyyDMPS) {
        getPersistence().clearCache(hyyDMPS);
    }
     ...
     */
    public static List<HyyDMPS> findWithDynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
     ...
     */
    public static List<HyyDMPS> findWithDynamicQuery(
     ...
     */
    public static HyyDMPS update(HyyDMPS hyyDMPS) throws SystemException {
        return getPersistence().update(hyyDMPS);
    }

    /**
     * @see com.liferay.portal.service.persistence.BasePersistence#update(com.liferay.portal.model.BaseModel, ServiceContext)
     */
    public static HyyDMPS update(HyyDMPS hyyDMPS, ServiceContext serviceContext)
        throws SystemException {
        return getPersistence().update(hyyDMPS, serviceContext);
    }
    ...
    */
    public static void cacheResult(fi.csc.smear.db.model.HyyDMPS hyyDMPS) {
        getPersistence().cacheResult(hyyDMPS);
    }
    ...
    */
    public static void cacheResult(
        ...
        getPersistence().cacheResult(hyyDMPSs);
    }
    ...
    */
    public static fi.csc.smear.db.model.HyyDMPS create(java.util.Date samptime) {
    ...
    */
    public static fi.csc.smear.db.model.HyyDMPS remove(java.util.Date samptime)
        throws com.liferay.portal.kernel.exception.SystemException,
            fi.csc.smear.db.NoSuchHyyDMPSException {
        return getPersistence().remove(samptime);
    }

    public static fi.csc.smear.db.model.HyyDMPS updateImpl(
        fi.csc.smear.db.model.HyyDMPS hyyDMPS)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getPersistence().updateImpl(hyyDMPS);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static fi.csc.smear.db.model.HyyDMPS findByPrimaryKey(
    ...
    * @throws SystemException if a system exception occurred
    */
    public static fi.csc.smear.db.model.HyyDMPS fetchByPrimaryKey(
        java.util.Date samptime)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<fi.csc.smear.db.model.HyyDMPS> findAll()
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static HyyDMPSPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (HyyDMPSPersistence) PortletBeanLocatorUtil.locate(fi.csc.smear.db.service.ClpSerializer.getServletContextName(),
                    HyyDMPSPersistence.class.getName());

            ReferenceRegistry.registerReference(HyyDMPSUtil.class,
                "_persistence");
        }
     ...
     */
    public void setPersistence(HyyDMPSPersistence persistence) {
    }
}
