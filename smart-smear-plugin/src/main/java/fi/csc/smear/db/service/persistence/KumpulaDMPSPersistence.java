...
/**
 * The persistence interface for the kumpula d m p s service.
 *
 * <p>
 ...
 * @generated
 */
public interface KumpulaDMPSPersistence extends BasePersistence<KumpulaDMPS> {
    /*
     * NOTE FOR DEVELOPERS:
     *
     * Never modify or reference this interface directly. Always use {@link KumpulaDMPSUtil} to access the kumpula d m p s persistence. Modify <code>service.xml</code> and rerun ServiceBuilder to regenerate this interface.
     */
    ...
    */
    public void cacheResult(fi.csc.smear.db.model.KumpulaDMPS kumpulaDMPS);
    ...
    */
    public fi.csc.smear.db.model.KumpulaDMPS create(java.util.Date samptime);
    ...
    */
    public fi.csc.smear.db.model.KumpulaDMPS remove(java.util.Date samptime)
        throws com.liferay.portal.kernel.exception.SystemException,
            fi.csc.smear.db.NoSuchKumpulaDMPSException;

    public fi.csc.smear.db.model.KumpulaDMPS updateImpl(
    ...
    * @throws SystemException if a system exception occurred
    */
    public fi.csc.smear.db.model.KumpulaDMPS findByPrimaryKey(
    ...
    * @throws SystemException if a system exception occurred
    */
    public fi.csc.smear.db.model.KumpulaDMPS fetchByPrimaryKey(
        java.util.Date samptime)
        throws com.liferay.portal.kernel.exception.SystemException;
    ...
    * @throws SystemException if a system exception occurred
    */
    public java.util.List<fi.csc.smear.db.model.KumpulaDMPS> findAll()
        throws com.liferay.portal.kernel.exception.SystemException;
