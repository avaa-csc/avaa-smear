...
/**
 * The persistence utility for the varriometa service. This utility wraps {@link VarriometaPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class VarriometaUtil {
    private static VarriometaPersistence _persistence;
     ...
     */
    public static void clearCache(Varriometa varriometa) {
        getPersistence().clearCache(varriometa);
    }
     ...
     */
    public static List<Varriometa> findWithDynamicQuery(
     ...
     */
    public static Varriometa update(Varriometa varriometa)
        throws SystemException {
        return getPersistence().update(varriometa);
    }
    ...
    public static Varriometa update(Varriometa varriometa,
        ...
        return getPersistence().update(varriometa, serviceContext);
    }
    ...
    */
    public static void cacheResult(fi.csc.smear.db.model.Varriometa varriometa) {
        getPersistence().cacheResult(varriometa);
    }
    ...
    */
    public static void cacheResult(
        ...
        getPersistence().cacheResult(varriometas);
    }
    ...
    */
    public static fi.csc.smear.db.model.Varriometa create(
    ...
    */
    public static fi.csc.smear.db.model.Varriometa remove(
        java.util.Date SAMPTIME)
    ...
    public static fi.csc.smear.db.model.Varriometa updateImpl(
        fi.csc.smear.db.model.Varriometa varriometa)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getPersistence().updateImpl(varriometa);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static fi.csc.smear.db.model.Varriometa findByPrimaryKey(
        java.util.Date SAMPTIME)
        throws com.liferay.portal.kernel.exception.SystemException,
            fi.csc.smear.db.NoSuchVarriometaException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static fi.csc.smear.db.model.Varriometa fetchByPrimaryKey(
        java.util.Date SAMPTIME)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<fi.csc.smear.db.model.Varriometa> findAll()
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static VarriometaPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (VarriometaPersistence) PortletBeanLocatorUtil.locate(fi.csc.smear.db.service.ClpSerializer.getServletContextName(),
                    VarriometaPersistence.class.getName());

            ReferenceRegistry.registerReference(VarriometaUtil.class,
                "_persistence");
        }
     ...
     */
    public void setPersistence(VarriometaPersistence persistence) {
    }
}
