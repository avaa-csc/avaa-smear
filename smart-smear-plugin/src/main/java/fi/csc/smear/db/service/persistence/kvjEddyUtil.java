...
/**
 * The persistence utility for the kvj eddy service. This utility wraps {@link kvjEddyPersistenceImpl} and provides direct access to the database for CRUD operations. This utility should only be used by the service layer, as it must operate within a transaction. Never access this utility in a JSP, controller, model, or other front-end class.
 *
 * <p>
 ...
 * @generated
 */
public class kvjEddyUtil {
    private static kvjEddyPersistence _persistence;
     ...
     */
    public static void clearCache(kvjEddy kvjEddy) {
        getPersistence().clearCache(kvjEddy);
    }
     ...
     */
    public static List<kvjEddy> findWithDynamicQuery(DynamicQuery dynamicQuery)
        throws SystemException {
     ...
     */
    public static List<kvjEddy> findWithDynamicQuery(
     ...
     */
    public static kvjEddy update(kvjEddy kvjEddy) throws SystemException {
        return getPersistence().update(kvjEddy);
    }

    /**
     * @see com.liferay.portal.service.persistence.BasePersistence#update(com.liferay.portal.model.BaseModel, ServiceContext)
     */
    public static kvjEddy update(kvjEddy kvjEddy, ServiceContext serviceContext)
        throws SystemException {
        return getPersistence().update(kvjEddy, serviceContext);
    }
    ...
    */
    public static void cacheResult(fi.csc.smear.db.model.kvjEddy kvjEddy) {
        getPersistence().cacheResult(kvjEddy);
    }
    ...
    */
    public static void cacheResult(
        ...
        getPersistence().cacheResult(kvjEddies);
    }
    ...
    */
    public static fi.csc.smear.db.model.kvjEddy create(java.util.Date samptime) {
    ...
    */
    public static fi.csc.smear.db.model.kvjEddy remove(java.util.Date samptime)
        throws com.liferay.portal.kernel.exception.SystemException,
            fi.csc.smear.db.NoSuchkvjEddyException {
        return getPersistence().remove(samptime);
    }

    public static fi.csc.smear.db.model.kvjEddy updateImpl(
        fi.csc.smear.db.model.kvjEddy kvjEddy)
        throws com.liferay.portal.kernel.exception.SystemException {
        return getPersistence().updateImpl(kvjEddy);
    }
    ...
    * @throws SystemException if a system exception occurred
    */
    public static fi.csc.smear.db.model.kvjEddy findByPrimaryKey(
    ...
    * @throws SystemException if a system exception occurred
    */
    public static fi.csc.smear.db.model.kvjEddy fetchByPrimaryKey(
        java.util.Date samptime)
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    * @throws SystemException if a system exception occurred
    */
    public static java.util.List<fi.csc.smear.db.model.kvjEddy> findAll()
        throws com.liferay.portal.kernel.exception.SystemException {
    ...
    */
    ...
    public static kvjEddyPersistence getPersistence() {
        if (_persistence == null) {
            _persistence = (kvjEddyPersistence) PortletBeanLocatorUtil.locate(fi.csc.smear.db.service.ClpSerializer.getServletContextName(),
                    kvjEddyPersistence.class.getName());

            ReferenceRegistry.registerReference(kvjEddyUtil.class,
                "_persistence");
        }
     ...
     */
    public void setPersistence(kvjEddyPersistence persistence) {
    }
}
